var projects = [
    {
        title: "Terrace",
        description: "We built an app to perform 3D photo effects! Here we're demonstrating the 3D ken burns effect.",
        image: "img/projects/terrace_3d_ken_burns.mp4",
        date: "January 2020",
        creator: "Ethan Weber, Avery Lamp"
    },
    {
        title: "Chicken Run AR",
        description: "Please see <a href=\"https://www.youtube.com/watch?v=qUiQNIgLkI4\">this video</a> for the project.",
        image: "img/projects/chicken_run_ar.png",
        date: "Fall 2019",
        creator: "Ethan Weber",
        favorite: true
    },
    {
        title: "SparKey",
        description: "",
        image: "img/projects/sparkey.mp4",
        date: "Fall 2018 - Spring 2019",
        creator: "Ethan Weber"
    },
    {
        title: "cARd",
        description: "Please see the cARd project <a href=\"https://devpost.com/software/card-a0grpe\">here</a>. Media for the project can be found <a href=\"https://photos.app.goo.gl/NxSBnUi8knA9KSYU8\">here</a>.",
    ...
    {
        title: "Atenta",
        description: "Please see <a href=\"https://medium.com/@ethanjohnweber/atenta-fixing-posture-and-improving-health-with-laptop-webcams-897c75ded2c6\">this write-up</a> for a project description.",
        image: "img/projects/atenta.mp4",
        date: "2018",
        creator: "Ethan Weber"
    },
    {
        title: "smARtable",
        description: "A smart table for interacting with objects. Please see media for the project <a href=\"https://photos.app.goo.gl/8jH8kXLJ2NqdKnFt2\">here</a>.",
        image: "img/projects/smartable.jpg",
        date: "2017-2018",
        creator: "Ethan Weber"
    },
    {
        title: "Inertially-Actuated Cube",
        description: "Please see the project <a href=\"http://ethanweber.me/cube.html\">here</a>.",
        image: "cube/cube.png",
        date: "Spring 2018",
        creator: "Ethan Weber"
    },
    {
        ...
        description: "Please see the project <a href=\"http://ethanweber.me/sleepcycle.html\">here</a>.",
        image: "sleep/body_and_eye_movements.png",
        date: "Spring 2018",
        creator: "Ethan Weber"
    },
    {
        title: "Cart Pole",
        description: "Please see the project <a href=\"http://ethanweber.me/cartpole.html\">here</a>.",
        image: "cartpole/cart_build.png",
        date: "Spring 2018",
        creator: "Ethan Weber"
    },
    {
        title: "TravelAR",
        description: "Traveling is exciting - planning, not so much. We thought about different ways to improve the vacation search process and found that visuals were key in selecting the perfect location. Because of this, we created TravelAR, an augmented reality app that allows you to physically step into scenes of different cities, then find flight information if you have found your ideal travel destination.<br><br>TravelAR is an iOS travel application built using Apple\u2019s ARKit. On opening the app, there is a camera view in the room. Upon tapping, there will be an augmented reality \"portal\" to another city, where you physically walk inside another \"room\" and view a gallery of AR scenes from the city. If interested in travel information to the city, there is a pull-up information section where a user can find relevant flight details and prices.<br><br>We built TravelAR with Apple\u2019s iOS ARKit, a Flask server hosted with Microsoft Azure, and many APIs including the Amadeus Travel APIs, the Microsoft Bing Image Search API, and the WolframAlpha Simple API. The iOS application submits a \u201CGET\u201D request to our Flask server hosted in the cloud with Microsoft Azure. This Flask server takes in a city/location name, and it processes that string with many APIs to extract information\u2014starting with the Amadeus Travel APIs. We hit the Amadeus endpoints with our location to gather information on popular attractions nearby, flight statistics, and other general travel information. We then port the \u201Cpopular attractions\u201D into the Microsoft Bing Image Search API to get a list of image urls that will be displayed in the iOS application. Furthermore, we use the WolframAlpha API to get information on the population. We combine all of the information with the AR to create a comprehensive visual display with helpful information.<br><br>Please check out a video of our project <a href=\"https://www.youtube.com/watch?v=ACneUIVByaY\">here</a> and our HackMIT submission <a href=\"https://devpost.com/software/travelar-g4sq6y\">here</a>.",
        image: "img/projects/travelar_image.jpg",
        date: "Fall 2017",
        creator: "Ethan Weber"
    },
    {
        title: "Jetslam Bot",
        description: "I\u2019ve spent the summer in Detroit working with a company called Zenuity--a company creating the autonomous vehicle software for Volvo. While at the company, I found the perfect opportunity to use my NVIDIA Jetson. The interns at Zenuity were assigned to a project called \"Park at Home\"--a project to formulate a solution to autonomously parking a car at home. My summer roommate, Luke--also from MIT--and I decided that it would be best to make a replica of the autonomous car by creating a cart fitted with many sensors and hardware. I believe that creating a live replica of a self-driving vehicle is the best way to rapidly develop software.<br><br>We had limited resources because Zenuity is a startup, so Luke and I created most of the cart with the hardware we had lying around at our apartment. We bought a cart from Harbor Freight, and made it look this this! \u200BThe cart is built with an NVIDIA Jetson TX1, a Raspberry Pi, an Arduino Uno, a 32x32 RGB LED matrix (which happens to be same one that I used on my high school grad cap), 3 USB cameras, the camera on-board the Jetson, an IMU with an accelerometer, and a Scanse Sweep 2D LIDAR. We named the cart the Jetslam Bot.<br><br>The goal of the cart was to demonstrate the computer vision algorithms (camera stitching, bird\u2019s eye view, line detection, etc.), occupancy grid (LIDAR data processing code), SLAM (Simultaneous Localization and Mapping), and LCM (the communication protocol we used). We are using the Jetson as the computer to handle all the processes and facilitate the communication throughout the used devices. The goal was to use the cart to have it create and localize itself within a map and act just like an autonomous car on a smaller scale! It demonstrated the computer vision programs that I wrote over the summer summer! The Jetson was a perfect way to bring together all of the code that Luke and I wrote.",
        image: "img/projects/jetslam_bot.JPG",
        date: "Summer 2017",
        creator: "Ethan Weber"
    },
    {
        title: "Family Escape Room Map",
        description: "I made a website that maps all of the escape rooms that my family and friends have done! My family loves escape rooms! See the site <a style=\"font-weight: bold\" href=\"http://weberescape.world\">here</a>.",
        image: "img/projects/escape_map.png",
        date: "Summer 2017",
        creator: "Ethan Weber"
    },
    {
        title: "ROS-MultiMaster-App",
        description: "While doing research in an MIT robotics lab focussing on using multiple robots to accomplish high-level tasks, there was need for an application that could easily synchronize ROS messages across computers. Welcome the ROS-MultiMaster-App! We created the ROS-MultiMaster-App as an easy-to-use web application to synchronize ROS topics and services throughout multiple computers--each running their own roscore--on the same network. Check it out at <a style=\"font-weight: bold\" href=\"https://github.com/ethanweber/ros-multimaster-app\">this repository</a> on my GitHub account.",
        image: "img/projects/ros-multimaster-app.png",
        date: "2017",
        creator: "Ethan Weber"
    },
    {
        title: "Block Game",
        description: "I made a puzzle block game where you have to get colored blocks to their respective goals by using barrier to maneuver. Check it out <a style=\"font-weight: bold\" href=\"block_game/block_game.html\">here</a>. Use arrow keys to move and refresh the page for a new layout. Note that there is no signal for winning in this version. Code is located at <a style=\"font-weight: bold\" href=\"https://github.com/ethanweber/block_game\">https://github.com/ethanweber/block_game</a>. I\u2019ve rewritten this Javascript applicaton in Qt for mobile use. Code for that is <a style=\"font-weight: bold\" href=\"https://github.com/ethanweber/motion_planning/tree/1f0cb9b471060b5b5dd9d5c9eb88069a2ffc7052/qt_block_game\">here</a>, and I was planning to use it for motion planning research. However, I\u2019ll update the block_game repo if more work continues on this project.",
        image: "img/projects/block_game.png",
        date: "2017",
        creator: "Ethan Weber"
    },
    {
        title: "AREALYTICS",
        description: "For places that have a large flow of human traffic throughout the days and nights, such as universities and convention centers, it\u2019s helpful for people running those institutions to have a good idea of where people travel most and how they move in certain times of the days. There was no efficient, simple way to accomplish this task until Arealytics came to life. Now we are able to passively track people\u2019s devices throughout various buildings and spaces. We can display this information on a dashboard system tailored towards a customer\u2019s needs: real-time data about customers, max flow rates of walkways, location hotspots, and we are currently leveraging the millions of data points available to create a predictive analytics solution.<br><br>How we accomplish this task is simple: we have reconfigured WiFi chips into a network of microcontrollers that detect DNS Probe Requests. DNS probe requests are essentially signals that WiFi devices broadcast out to the routers nearby with their MAC address saying, \u201CHey, I\u2019m here! Allow me to build a connection with you.\u201D We store all of these probe requests by logging MAC addresses, timestamps, signal strengths, and more. With this information, we can model the paths that people took throughout the day. We will also provide vital information to businesses and institutions about where to create new working spaces, where to perform construction, and where to relocate sites to optimal locations.<br><br>Check out <a href=\"documents/Arealytics_Final_Report.pdf\">our report</a> for more information.",
        image: "img/projects/arealytics_state_machine.png",
        date: "Spring 2017",
        creator: "Ethan Weber"
    },
    {
        title: "LED Matrix High School Graduation Cap",
        description: "This is my New Holstein High School graduation cap using a 32 x 32 RGB LED matrix controlled by a Raspberry Pi 2. Check it out on YouTube <a style=\"font-weight: bold\" href=\"https://www.youtube.com/watch?v=dShCYXGweCg\">here</a>.",
        image: "img/projects/high_school_grad_cap.jpg",
        date: "2016",
        creator: "Ethan Weber",
        favorite: true
    },
...
function renderProjects(projects) {
    var grid = document.getElementById("portfolio_grid_id");
    var modals = document.getElementById("portfolio_models_id");
    ...
    projects.forEach(function(p, i) {
        var idx = i + 1;
        var isVideo = p.image.split('.').pop() === 'mp4';
        var favClass = p.favorite ? ' project-favorite' : '';
        var favTitle = p.favorite ? ' title="\u2B50 Personal favorite"' : '';

        var mediaTag = isVideo
            ? '<video src="' + p.image + '" muted playsinline loop preload="metadata"></video>'
            : '<img src="' + p.image + '" loading="lazy" decoding="async" alt="' + p.title + '">';

        gridParts.push(
            '<a href="#portfolioModal' + idx + '" class="project-card' + favClass + '"' + favTitle + ' data-toggle="modal">' +
                '<div class="project-card-img">' + mediaTag + '</div>' +
                '<div class="project-card-title">' + p.title + '</div>' +
                '<div class="project-card-date">' + p.date + '</div>' +
            '</a>'
        );

        var modalMedia = isVideo
            ? '<video data-src="' + p.image + '" class="project-modal-img" muted playsinline loop></video>'
            : '<img src="' + p.image + '" class="project-modal-img" loading="lazy" decoding="async">';

        modalParts.push(
            '<div class="modal fade project-modal" id="portfolioModal' + idx + '" tabindex="-1" role="dialog" aria-hidden="true">' +
    ...
    grid.innerHTML = gridParts.join('');
    modals.innerHTML = modalParts.join('');
    ...
    document.querySelectorAll('.project-filters .pub-filter-btn').forEach(function(btn) {
        btn.addEventListener('click', function(e) {
            ...
            window.scrollBy(0, btn.getBoundingClientRect().top - btnTop);
        });
    });

    // Play/pause grid videos based on viewport
    ...
    document.querySelectorAll('.project-card-img video').forEach(function(v) {
        videoObserver.observe(v);
    });

    // Scroll reveal (uses shared utility defined in index.html)
    if (window.initReveal) {
        window.initReveal(document.querySelectorAll('.project-card'), 4, 0.06);
    }

    // Modal video lazy-load via Bootstrap events ($ is available -- defer ordering guarantees it)
    $(document).on('shown.bs.modal', '.project-modal', function() {
        var video = this.querySelector('video[data-src]');
        if (video) {
    ...
    $(document).on('hidden.bs.modal', '.project-modal', function() {
