let publications = [
    ...
    },
    {
        ...
        "authors": "Matthew Tancik*, <b>Ethan Weber*</b>, Evonne Ng*, Ruilong Li, Brent Yi, Justin Kerr, Terrance Wang, Alexander Kristoffersen, Jake Austin, Kamyar Salahi, Abhik Ahuja, David McAllister, Angjoo Kanazawa",
        ...
        "media": "img/publications/nerfstudio.png",
    },
    {
        "title": "The One Where They Reconstructed 3D Humans and Environments in TV Shows",
        "authors": "Georgios Pavlakos*, <b>Ethan Weber*</b>, Matthew Tancik,  Angjoo Kanazawa",
    ...
    },
    {
        ...
        "authors": "Vongani H. Maluleke, Neerja Thakkar, Tim Brooks, <b>Ethan Weber,</b> Trevor Darrell, Alexei A. Efros, Angjoo Kanazawa, Devin Guillory",
        "conference": "ECCV 2022",
    ...
    },
    {
        ...
        "authors": "<b>Ethan Weber,</b> Dim P. Papadopoulos, Agata Lapedriza, Ferda Ofli, Muhammad Imran, Antonio Torralba",
    ...
    },
    {
        ...
        "authors": "<b>Ethan Weber,</b> Nuria Marzo, Dim P. Papadopoulos, Aritro Biswas, Agata Lapedriza, Ferda Ofli, Muhammad Imran, Antonio Torralba",
    ...
    },
    {
        ...
        "presentation": "https://slideslive.com/38926353/building-disaster-damage-assessment-in-satelite-imagery-with-multitemporal-fusion",
        ...
        let publicationHTML = `
            <div class="publication-entry">
                <div class="publication-text">
                    <p>
                        <span class="paper-title">${publication.title}</span><br>
                        ${publication.authors.replace(/, (?=[^,]*$)/, ', and ')}.<br><br>
                        ${publication.conference ? publication.conference + ' ' : ''}<br>
                        ${publication['project-page'] ? '| <a href="' + publication['project-page'] + '">Project Page</a>' : ''}
                        ${publication.paper ? '| <a href="' + publication.paper + '">Paper</a>' : ''}
                        ${publication.code ? '| <a href="' + publication.code + '">Code</a>' : ''}
                        ${publication.presentation ? '| <a href="' + publication.presentation + '">Presentation</a>' : ''}
                        ${publication['thesis-page'] ? '| <a href="' + publication['thesis-page'] + '">Thesis Page</a>' : ''}
                        ${'|'}
                    </p>
                </div>
                ${mediaHTML}
